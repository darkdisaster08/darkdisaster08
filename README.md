...
> *"9+ years of real-world industry experience meets cybersecurity — bringing a unique attacker & defender mindset forged on the factory floor."*
...
- 🏭 9+ years in Electronics & Battery Manufacturing...
- 🖥️ Managed MES systems...
- 🔨 Built a home lab running pfSense...
- 🚩 Completed OWASP Top 10 web vulnerability testing...
- 🔧 Built DarkBuster — open source web directory bruteforcer...
...
- 🔹 Networking Fundamentals (OSI, TCP/IP, Subnetting, Protocols)
- 🔹 Network Security (Firewalls, IDS/IPS, VPN, DMZ, Honeypots)
- 🔹 Vulnerability Assessment & Management (CVSS, VAPT)
- 🔹 Network & Advanced Penetration Testing (OSINT, Post-Exploitation, Privilege Escalation)
...
```
Internet → pfSense Firewall (Mini PC)
               ├── pfBlockerNG (IP/DNS blocking — 14,000+ blocked IPs)
               ├── PIA VPN Integration
...
*"Security isn't just about tools — it's about understanding systems deeply. 9 years of industry experience taught me that."*
